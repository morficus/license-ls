...
* `--header.*`: changes the default header name for table output (ie: `--header.name=Module`)
  * Here is a list of possible values for `*`: `id`, name`, `version`, `license`, `homepage`, `repository`, `author`, `dependencyLevel`

### CSV specific options 
* `--delimiter`: character the use as the value separator (defaults to `,`)

### XML specific options
* `--xml.as-attrs`: uses each package property as the XML tag element, with the package name as the content (see "XML Output #2" in the Examples section) 
...
<dependencies>
    <dependency>
        <id>0</id>
        <name>license-ls</name>
        <version>1.0.0</version>
        <license>MIT License (MIT)</license>
        <repository>git+https://github.com/morficus/license-ls.git</repository>
        <author>Maurice Williams</author>
        <homepage>https://github.com/morficus/license-ls#readme</homepage>
...
### XML Output #2
```npx license-ls --depth=0 --format=xml --xml.as-attrs```
```xml
<dependencies>
    <dependency id="0" version="1.0.0" license="MIT License (MIT)" repository="git+https://github.com/morficus/license-ls.git" author="Maurice Williams" homepage="https://github.com/morficus/license-ls#readme" dependencyLevel="production">license-ls</dependency>
    <dependency id="1" version="2.1.0" license="MIT License (MIT)" repository="git+https://github.com/avajs/ava.git" author="" homepage="https://avajs.dev" dependencyLevel="development">ava</dependency>
    <dependency id="2" version="4.1.1" license="MIT License (MIT)" repository="git://github.com/visionmedia/debug.git" author="TJ Holowaychuk" homepage="https://github.com/visionmedia/debug#readme" dependencyLevel="development">debug</dependency>
    <dependency id="3" version="4.5.1" license="MIT License (MIT)" repository="git+https://github.com/zemirco/json2csv.git" author="Mirco Zeiss" homepage="https://github.com/zemirco/json2csv#readme" dependencyLevel="production">json2csv</dependency>
    <dependency id="4" version="1.5.0" license="MIT License (MIT)" repository="git://github.com/davidcalhoun/jstoxml.git" author="David Calhoun" homepage="http://github.com/davidcalhoun/jstoxml" dependencyLevel="production">jstoxml</dependency>
    <dependency id="5" version="2.0.1" license="ISC License (ISC)" repository="git+https://github.com/npm/libnpm.git" author="Kat Marchán" homepage="https://github.com/npm/libnpm#readme" dependencyLevel="production">libnpm</dependency>
    <dependency id="6" version="14.1.1" license="ISC License (ISC)" repository="git+ssh://git@github.com/istanbuljs/nyc.git" author="Ben Coe" homepage="https://github.com/istanbuljs/nyc#readme" dependencyLevel="production">nyc</dependency>
    <dependency id="7" version="3.4.0" license="MIT License (MIT)" repository="git+https://github.com/sindresorhus/ora.git" author="Sindre Sorhus" homepage="https://github.com/sindresorhus/ora#readme" dependencyLevel="production">ora</dependency>
    <dependency id="8" version="5.2.2" license="ISC License (ISC)" repository="git+https://github.com/npm/read-package-tree.git" author="Isaac Z. Schlueter" homepage="https://github.com/npm/read-package-tree" dependencyLevel="production">read-package-tree</dependency>
    <dependency id="9" version="3.0.0" license="MIT License (MIT)" repository="git+https://github.com/jslicense/spdx-expression-parse.js.git" author="Kyle E. Mitchell" homepage="https://github.com/jslicense/spdx-expression-parse.js#readme" dependencyLevel="production">spdx-expression-parse</dependency>
    <dependency id="10" version="6.0.0" license="Creative Commons Zero v1.0 Universal (CC0-1.0)" repository="git+https://github.com/sindresorhus/spdx-license-list.git" author="Sindre Sorhus" homepage="https://github.com/sindresorhus/spdx-license-list#readme" dependencyLevel="production">spdx-license-list</dependency>
    <dependency id="11" version="5.4.1" license="BSD 3-Clause &quot;New&quot; or &quot;Revised&quot; License (BSD-3-Clause)" repository="git+https://github.com/gajus/table.git" author="Gajus Kuizinas" homepage="https://github.com/gajus/table#readme" dependencyLevel="production">table</dependency>
    <dependency id="12" version="13.2.4" license="MIT License (MIT)" repository="git+https://github.com/yargs/yargs.git" author="" homepage="https://yargs.js.org/" dependencyLevel="production">yargs</dependency>
</dependencies>
```
